...
%define COMMON_CONFIGURE_ARGS $(echo "\
        ...
        --add-dynamic-module=nginx-goodies-nginx-sticky-module-ng-08a395c66e42 \
        --with-threads \
        --with-stream \
...
Source12: COPYRIGHT
Source13: nginx-sticky-module-1.0.tar.gz
...
This is a repackage that includes the sticky-module
